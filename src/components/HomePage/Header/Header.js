...
const Header = () => {
    return (
        <div className='py-0 py-lg-4 container '>
            <div className='mobile-logo-section'>
                <div className='mobile-logo'>
                    <img src={logo} alt="" />
                </div>
                <div className='d-flex flex-column flex-lg-row navigation-bar'>
                    <div className='w-100 bg-black menu-sm'>
                        <p className='text-white fs-1'><GiHamburgerMenu className='me-3' />Menu</p>
                    </div>
                    ...
                    <div className='mt-2 pe-2 pe-lg-0 mt-lg-0 pt-3 pt-lg-0 d-flex nav-contact align-items-center'>
